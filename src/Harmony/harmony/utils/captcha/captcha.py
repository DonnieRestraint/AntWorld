...
class Captcha(object):
    ...
    def text(self, image, fonts, font_sizes=None, drawings=None, squeeze_factor=0.75, color=None):
        ...
        for c in self._text:
            ...
            c_leftup_x, c_leftup_y, c_width, c_height = draw.textbbox((0, 0), c, font)
    ...
    def rotate(image, angle=25):
        return image.rotate(
            random.uniform(-angle, angle), Resampling.BILINEAR, expand=1)
...
if __name__ == '__main__':
    name, text, bytes_data = captcha.generate_captcha()
    from PIL import Image
